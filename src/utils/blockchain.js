...
// Transaction type metadata (for UI rendering)
export const TX_META = {
  NOTE_CREATED:      { label: "Note Created",      color: "var(--c1)",  icon: "➕" },
  NOTE_VIEWED:       { label: "Note Viewed",        color: "var(--c2)",  icon: "👁" },
  NOTE_DELETED:      { label: "Note Deleted",       color: "var(--c3)",  icon: "🗑" },
  NOTE_EXPIRED:      { label: "Note Expired",       color: "var(--c4)",  icon: "⏰" },
  AUTH_FAILED:       { label: "Auth Failed",        color: "#ff9500",    icon: "⚠️" },
  CHAIN_INITIALIZED: { label: "Chain Initialized",  color: "var(--c5)",  icon: "⛓" },
};
