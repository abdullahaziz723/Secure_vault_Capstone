  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      await recordTransaction(
        "NOTE_CREATED",
        id.slice(0, 8),
        `Note "${title || "Untitled"}" created — ${oneTime ? "one-time" : "multi-view"}, expires: ${expiry}`,
        { tags, oneTime, hasPassword: usePassword },
      );
    ...
    return (
      <div className="fade-in">
        <div className="alert alert-success mb-2">
          ...
          <span>
            Note encrypted and stored successfully. Share the link below with
        ...
        <div className="card mb-2">
          ...
          <div className="card-body">
            <div className="alert alert-warn mb-2">
              ...
              <span>
                Copy this link now — it won't be shown again after you navigate
                away.
              </span>
            </div>
            ...
            {result.pass && (
              <div style={{ marginTop: ".75rem" }}>
                <div className="divider-text">
                  Decryption key embedded in link
                </div>
                <div className="link-box">
                  <code style={{ fontSize: ".68rem", opacity: 0.7 }}>
                    {result.pass}
                  </code>
                  <button
                    className="copy-btn"
                    onClick={() => handleCopy(result.pass)}
                  >
                    Copy key
                  </button>
                </div>
            ...
            >
              {oneTime && (
                <span className="badge badge-red">💣 One-time view</span>
              )}
              {expiry !== "never" && (
                <span className="badge badge-warn">⏱ Expires in {expiry}</span>
              )}
              {usePassword && (
                <span className="badge badge-cyan">🔑 Password protected</span>
              )}
        ...
        <div className="card">
          <div className="card-header">
            <span className="card-title">📋 Note Details</span>
          </div>
          <div className="card-body">
            <div className="grid-2">
              {[
                ...
                [
                  "Password",
                  usePassword ? "Yes (hash stored)" : "No (key in URL)",
                ],
              ].map(([k, v]) => (
                <div
                  key={k}
    ...
    <div className="fade-in">
      ...
      {tab === "compose" && (
        <div className="fade-in">
          <div className="card mb-2">
            <div className="card-header">
              <span className="card-title">✏️ Compose Message</span>
            </div>
            <div className="card-body">
              <div className="field">
              ...
              <div className="field">
                ...
                <div className="char-count">
                  {note.length} characters · ~{Math.round(note.length / 5)}{" "}
                  words
                </div>
              </div>
              <div className="field">
      ...
      {tab === "options" && (
        <div className="fade-in">
              ...
              <div className="field">
                ...
                >
                  <div className="toggle-info">
                    ...
                    <div className="td">
                      Recipient must enter a password to decrypt
                    </div>
                  </div>
          ...
          <div className="card mb-2">
            <div className="card-header">
              <span className="card-title">⏱ Expiry & Access Control</span>
            </div>
            <div className="card-body">
              ...
              <div className="field">
                ...
                >
                  <div className="toggle-info">
                    ...
                    <div className="td">
                      Note is permanently destroyed after first view
                    </div>
                  </div>
          ...
          <button
            ...
            disabled={
              loading ||
              !note.trim() ||
              (usePassword && (!password || password !== confirmPw))
            }
          >
            {loading ? (
              <>
      ...
      {tab === "preview" && (
        <div className="fade-in">
          <div className="card mb-2">
            <div className="card-header">
              <span className="card-title">👁 Note Preview</span>
            </div>
            <div className="card-body">
              {title && (
                <div
              ...
              <div className="note-reveal blurred">
                {note || "No content yet..."}
              </div>
              <div
                style={{
            ...
            <div className="card-body">
              {[
                ...
                [
                  "Password",
                  usePassword
                    ? `Yes (strength: ${PW_LABELS[pwLevel]})`
                    : "Auto-generated (embedded in link)",
                ],
                ...
                <div
                  ...
                  style={{
                    ...
                    justifyContent: "space-between",
                    padding: ".5rem 0",
                    borderBottom: "1px solid rgba(26,37,53,.6)",
                    fontSize: ".78rem",
                  }}
                >
